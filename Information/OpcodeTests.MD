...
`8xy4` - Add the values of register `x` and register `y` together. Put the resulting value into register `x`. Set register 15 to 1 if register `x` goes over 255: 0 otherwise even if `x` equals 15. 
